...
const Raise = ({ description, ticker, raising_on, raising_in, token_address, smartcontractaddress, smartcontractabi }) => {
  ...
  const goal = parseFloat(fundraising.totalToRaise / 1000000000000000000 || '1');
  const alreadyCaptured = parseFloat(fundraising.alreadyCaptured / 1000000000000000000 || '0');
